...
MACRO_CONFIG_STR(SvGametype, sv_gametype, 32, "rifle", CFGFLAG_SERVER, "Game type (dm, tdm, ctf)")
...
//Team Rifle
MACRO_CONFIG_INT(SvRespawnDelayTRIFLE, sv_respawn_delay_trifle, 3, 0, 10, CFGFLAG_SERVER, "Time needed to respawn after death in trifle gametype")
